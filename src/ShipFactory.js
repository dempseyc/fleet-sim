...
export class ShipFactory {
    ...
    constructor (banner) {
        ...
        this.features = {
            shields: [
                ...
                {power: this.baselines.sh+(this.multipliers.sh*2), owned_by: ['average']},
            ...
            weapons: [
                ...
                {power: this.baselines.wp+(this.multipliers.wp*2), owned_by: ['average', 'swift']},
            ...
            engines: [
                ...
                {power: this.baselines.eg+(this.multipliers.eg*2), owned_by: ['average','transport','gunner']},
    ...
    // lookup reversed from features
        this.profiles = {
            average: [this.features.shields[2].power,this.features.weapons[2].power,this.features.engines[2].power],
    ...
    buildShip (color,style,idx) {
        ...
        return new Ship(color,style,profile,idx);
    }
